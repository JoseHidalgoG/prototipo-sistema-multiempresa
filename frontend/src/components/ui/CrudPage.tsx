                  ...
                  <tr key={item[idKey]}>
                    ...
                    <td>
                      <div className="flex items-center justify-end gap-1">
                        <button className="btn-ghost btn-sm rounded-lg" onClick={() => openEdit(item)} title="Editar">
                          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                        </button>
                        <button className="btn-ghost btn-sm rounded-lg text-red-500 hover:text-red-700 hover:bg-red-50" onClick={() => setDeleteConfirm(item[idKey])} title="Eliminar">
